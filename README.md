...
> **État : M3 terminé, canal de mise à jour signé complet (ADR-002), M4 (réseau) entamé.**
...
> 388 tests, binaire de 9,4 Mo sans installation. Les contrôles sont des fichiers YAML.
...
> WinHTTP, avec récupération opt-in du script PAC) sont audités. Restent le test actif
> DoH/DoT et les profils Wi-Fi — voir [ROADMAP.md](docs/ROADMAP.md). **L'audit
...
```bash
dotnet test                                   # 388 tests (48 exigent Windows), ~10 s
